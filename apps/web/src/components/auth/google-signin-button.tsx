    ...
    <div className="flex flex-col items-center justify-center w-full gap-2 mt-4">
      ...
      {!GOOGLE_CLIENT_ID ? (
        <button
          ...
          className="flex h-11 w-full max-w-[320px] items-center justify-center gap-2.5 rounded-lg border border-slate-200 bg-surface px-4 py-2.5 text-sm font-bold text-slate-700 hover:border-slate-300 hover:bg-slate-50 transition-all focus:outline-none"
        >

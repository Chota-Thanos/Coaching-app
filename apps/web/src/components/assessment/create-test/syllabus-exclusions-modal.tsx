      ...
      <div className="flex max-h-[85vh] w-full max-w-xl flex-col overflow-hidden rounded-2xl border border-slate-100 bg-surface shadow-2xl">
        <div className="flex items-center justify-between border-b border-slate-100 bg-slate-50/50 p-5">
          <div>
            <h3 className="flex items-center gap-2 text-base font-black text-slate-900">
              <SlidersHorizontal className="h-4 w-4 text-indigo-650" aria-hidden="true" />
        ...
        <div className="flex flex-wrap items-center justify-between gap-3 border-t border-slate-100 bg-slate-50/50 p-4">
          <button
            ...
            disabled={saving}
            onClick={handleReset}
            className="rounded-xl bg-slate-100 px-4 py-2 text-xs font-extrabold text-slate-655 transition hover:bg-slate-200 disabled:opacity-50"
          >
            Reset to Default
          </button>
          <div className="ml-auto flex items-center gap-2">
            ...
            <button
              ...
              disabled={saving}
              onClick={handleSave}
              className="flex items-center gap-1.5 rounded-xl bg-indigo-650 px-5 py-2 text-xs font-black text-white shadow-md shadow-indigo-650/10 transition hover:bg-indigo-600 disabled:opacity-50"
            >

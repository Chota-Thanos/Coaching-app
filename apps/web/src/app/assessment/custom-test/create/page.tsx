      ...
      <>
        <div className="min-h-screen bg-gradient-to-br from-slate-950 via-indigo-950 to-slate-900 flex items-center justify-center p-4">
          <div className="w-full max-w-md">
            <div className="bg-surface rounded-3xl shadow-2xl p-8 space-y-7">
    ...
    <div className="min-h-screen bg-slate-50/50 pb-20">
        ...
        <div className="mx-auto max-w-7xl flex items-center justify-between">
          ...
          <div>
            <Link
              ...
              className="inline-flex items-center gap-1.5 rounded-xl border border-slate-200 bg-surface px-4.5 py-2 text-xs font-bold text-slate-700 shadow-sm hover:bg-slate-50 transition"
            >
      ...
      <div className="mx-auto max-w-7xl px-4 mt-8">
        ...
        <form onSubmit={handleCreateTest} className="grid grid-cols-1 lg:grid-cols-3 gap-8">
          ...
          <div className="lg:col-span-1 space-y-6">
            ...
            <div className="rounded-2xl border border-slate-100 bg-surface p-5 shadow-sm space-y-4">
              ...
              <label className="block text-xs font-extrabold text-slate-500 uppercase tracking-widest space-y-2">
                ...
                <select
                  ...
                  className="h-11 w-full rounded-xl border border-slate-200 bg-surface px-3 text-sm font-semibold text-slate-900 outline-none focus:border-indigo-600 focus:ring-2 focus:ring-indigo-600/10 normal-case"
                >
                  {exams.map((exam) => (
            ...
            <div id="tour-basket-card" className="rounded-2xl border border-slate-100 bg-surface p-5 shadow-sm space-y-4">
              <div>
                  ...
                  {addedCategories.map((item) => (
                    ...
                    >
                      ...
                      <button
                        ...
                        className="grid h-7 w-7 place-items-center rounded-lg border border-slate-200 bg-surface text-slate-400 hover:text-rose-600 hover:border-rose-100 shadow-sm transition"
                      >
              ...
              {loadingCategories || loadingCounts ? (
                ...
                <div className="space-y-4 max-h-[600px] overflow-y-auto pr-1">
                  {subjects.map((sub, idx) => {
                    ...
                    return (
                      <div key={sub.id} className="rounded-xl border border-slate-100 bg-surface p-4 space-y-3">
                                ...
                                >
                                  ...
                                  {topicAvailable > 0 ? (
                                    <div className="flex items-center gap-3 shrink-0">
                                      ...
                                      <div className="flex items-center border border-slate-200 rounded-md bg-surface">
                                        <button
                                          type="button"
      ...
      {isFilterModalOpen && (
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-slate-900/60 backdrop-blur-sm transition-all duration-300">
          <div className="relative w-full max-w-2xl rounded-2xl bg-surface border border-slate-100 shadow-2xl overflow-hidden flex flex-col max-h-[85vh] animate-in fade-in zoom-in-95 duration-200">
            {/* Header */}
            ...
            <div className="p-4 border-t border-slate-100 bg-slate-50/50 flex items-center justify-between gap-3 flex-wrap">
              ...
              <div className="flex items-center gap-2 ml-auto">
                <button
                  ...
                  className="px-4 py-2 text-xs font-bold text-slate-500 hover:text-slate-700 bg-surface border border-slate-200 hover:border-slate-300 rounded-xl transition"
                >
                  Cancel
                </button>
                <button

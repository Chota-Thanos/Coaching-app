...
// its sections, relations and appearance count. Mirrors the fields exposed on
// the public article page (frontend-read.service.ts getPublishedArticleBySlug)
// so student workspace views (forks/collections) stay live against the same
// source data instead of a frozen copy.
